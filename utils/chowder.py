import warnings
import torch
from rl_benchmarks.models.slide_models.utils.extreme_layer import ExtremeLayer
from rl_benchmarks.models.slide_models.utils.mlp import MLP
from rl_benchmarks.models.slide_models.utils.tile_layers import TilesMLP
from typing import Optional, List
import torch.nn as nn
# Train downstream MIL model with input data
...
class Chowder(nn.Module):
    ...
    def __init__(
        ...
        ## if shape == (patient batch x batch per patient x m x n):
    ...
    def forward(
        ...
        # print('selected scores shape:', extreme_scores.shape)
